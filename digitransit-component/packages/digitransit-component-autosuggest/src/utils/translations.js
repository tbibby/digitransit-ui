...
const translations = {
  ...
  ga: {
    translation: {
      ...
      address: 'Seoladh',
      'address-place-or-business': 'Seoladh, áit nó gnó',
      airplane: 'Eitleán',
      arrival: 'Teacht',
      back: 'Ar ais',
      bikepark: 'Páirceáil agus Taisteal do rothair',
      bikerentalstation: 'Stáisiún rothar cathrach',
      bus: 'bus',
      cancel: 'Cealaigh',
      carpark: 'Páirceáil agus Taisteal',
      'clear-button-label': 'Glan',
      'clear-search-history': 'Glan stair an chuardaigh',
      currentposition: 'Suíomh reatha',
      delete: 'Scrios',
      'delete-old-searches-header':
        'Ar mhaith leat stair an chuardaigh a ghlanadh?',
      departure: 'Imeacht',
      destination: 'Ceann scríbe',
      favourite: 'Ceanán',
      ferry: 'Bád fartha',
      'future-route': 'Bealach amach anseo',
      'give-destination': 'Cuir isteach do cheann scríbe',
      'give-origin': 'Cuir isteach do phointe tosaigh.',
      loading: 'Á luchtú...',
      'minute-short': 'nóim',
      origin: 'Pointe tosaigh',
      'origin-stop-near-you': 'Pointe tosaigh',
      ownlocations: 'M’áiteanna féin',
      place: 'Suíomh',
      platform: 'Ardán',
      rail: 'Traein',
      required: 'réimse riachtanach',
      search: 'Cuardaigh',
      'search-address-or-place': 'Cuardaigh de réir seolta nó ainm áite',
      'search-autosuggest-label': 'Cuardach ionad, áit agus stad.',
      'search-autosuggest-label-instructions-desktop':
        'Nascleanúint an liosta le heochracha saighde agus roghnaigh le heochair enter.',
      'search-autosuggest-label-instructions-mobile':
        'Cuir isteach an suíomh agus nascleanúint an liosta ach sciorradh.',
      'search-autosuggest-label-move-to-destination':
        'Tar éis duit an pointe tosaigh a roghnú, bogfar thú go huathoibríoch go dtí an réimse ceann scríbe.',
      'search-autosuggest-len': 'Tá {{count}} mholadh ar fáil',
      'search-autosuggest-len_plural': 'Tá {{count}} mholtaí ar fáil',
      'search-button-label': 'Cuardaigh',
      'search-current-suggestion': 'Rogha reatha: {{selection}}',
      'search-destination': 'Cuardaigh ceann scríbe, bealach nó stad',
      'search-destination-index': 'Cuir isteach an ceann scríbe',
      'search-destination-results-but-no-search':
        'Féach na torthaí sa chluaisín “Ceann scríbe” in aice láimhe',
      'search-no-results': 'Níor aimsíodh aon áit',
      'search-origin': 'Cuardaigh pointe tosaigh, bealach nó stad',
      'search-origin-index': 'Cuir isteach an pointe tosaigh',
      'search-position': 'Aimsigh suíomh',
      'select-from-map': 'Roghnaigh suíomh ón léarscáil',
      'select-from-own-locations': 'Roghnaigh ó m’áiteanna féin',
      station: 'Stáisiún',
      stop: 'Stad',
      'stop-near-you': 'Cuardaigh stadanna agus bealaí',
      'stop-near-you-airplane': 'Cuardaigh eitiltí nó aerfoirt',
      'stop-near-you-bikepark': 'Cuardaigh páirceáil agus taisteal do rothair',
      'stop-near-you-bus': 'Cuardaigh bealaí bus nó stadanna',
      'stop-near-you-carpark': 'Cuardaigh páirceáil agus taisteal do charranna',
      'stop-near-you-citybike': 'Cuardaigh stáisiúin rothar cathrach',
      'stop-near-you-rail': 'Cuardaigh bealaí traenach nó stáisiúin',
      'stop-near-you-subway': 'Cuardaigh bealaí meitreo nó stáisiúin',
      'stop-near-you-tram': 'Cuardaigh bealaí tram nó stadanna',
      'stop-route-station': 'Cuardach bus agus stad',
      street: 'Sráid',
      subway: 'Meitreo',
      'today-at': 'inniu ag',
      'tomorrow-at': 'amárach ag',
      track: 'Raon',
      tram: 'Tram',
